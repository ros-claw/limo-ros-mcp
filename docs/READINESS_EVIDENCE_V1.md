...
to match it, and removes caller-supplied readiness booleans. REAL execution additionally
requires the daemon-owned ROS 1 worker to rerun live AMCL, lidar, odometry, chassis, TF,
and move_base preflight before it dispatches the goal.
