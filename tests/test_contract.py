...
def test_contract_exposes_only_source_backed_interfaces() -> None:
    ...
    assert contract["safety"]["real_navigation_enabled"] is True
    assert contract["safety"]["navigation_daemon_preflight_required"] is True
    assert contract["safety"]["real_tone_enabled"] is True
